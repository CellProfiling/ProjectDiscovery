...
if nargin<1 || isempty(inpath)
    inpath = '../pd_data/201607121468334823219_tasks.tab';
end

if nargin <2 || isempty(outpath)
    outpath = ['./pdAnalysisIntermediate',filesep];
end
...
if nargin<6 || isempty(parsed_outpath)
    parsed_outpath = [outpath,filesep,'parsedTQdata',inpath_base,cell_line,'.mat'];
end
